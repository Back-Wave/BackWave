...
Required Notice: Copyright © DeVito Digital Solutions LLC (https://backwave.app)

This license governs the free BackWave packages — `BackWave`, `BackWave.Hosting`,
`BackWave.Postgres`, `BackWave.SqlServer`, `BackWave.Sqlite`, `BackWave.EntityFrameworkCore`,
`BackWave.OpenTelemetry`, `BackWave.Testing`, `BackWave.Conformance`, and `BackWave.Dashboard`. The
`BackWave.Pro.*` packages are **not** covered here; they are licensed under the BackWave Pro
Commercial License Agreement (see `LICENSE-PRO.md`).
