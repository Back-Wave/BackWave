...
/// validation boundaries and the default-vs-custom <c>Rewrite</c> substitution. Pure unit tests — no
/// database.
/// </summary>
public sealed class SchemaRewriterTests
{
    // SQL Server identifiers cap at 128 characters (mirrors SchemaRewriter.MaxSchemaLength).
